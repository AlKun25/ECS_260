...
def main(org):
    ...
    headers = ['org', 'repo', 'year', 'week', 'total_devs', 'multitask_devs',
            ...
            'avg_shared_dev_commits', 'avg_total_shared_dev_commits', 'median_total_shared_dev_commits', 'lines_added', 'modified_files', 'multitask_ratio', 'release_major', 'release_minor', 'release_major_minor', 'release_patch',  'avg_multitasking_repos_count', 'max_multitasking_repos_count', 'median_multitasking_repos_count', 'sum_s_focus', 'created_since']


    data = []

    for unique_repo in unique_repos:
        # print(org, unique_repo)
    ...
    #             if len(filtered_df_weekly) > 0:
                ...
                data.append([org, unique_repo, year, week, total_devs, shared_devs, total_commits, shared_commits, freq_commits, avg_unit_complexity, avg_unit_size, avg_shared_dev_commits, avg_total_shared_dev_commits, median_shared_dev_commits, lines, modified_files, multitask_ratio, release_major, release_minor, release_major_minor, release_patch, avg_multitasking_repos, max_multitasking_repos, median_multitasking_repos, sum_s_focus, created_since])


    with open(f'output/_rq2/fix/{org}_processed.csv', mode='w', newline='', encoding='utf-8') as file:
