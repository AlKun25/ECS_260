...
def main(org):
    ...
    headers = ['org', 'repo', 'weeks_between_major_major', 'total_devs', 'multitask_devs', 'singletask_devs', 'multitask_ratio']
...
# #             if len(filtered_df_weekly) > 0:
        ...
        data.append([org, unique_repo, weeks_between_major, total_devs, shared_devs, non_shared_devs, multitask_ratio])


    with open(f'output/_rq1/major/{org}_processed.csv', mode='w', newline='', encoding='utf-8') as file:
